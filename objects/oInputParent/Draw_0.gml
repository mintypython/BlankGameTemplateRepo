...
if input_binding_scan_in_progress() {
	...
	drawCenterText(room_width / 2, room_height / 2, "Select new input...")
	drawCenterText(room_width / 2, room_height / 2 + 64, string(ceil(input_binding_scan_time_remaining() / 1000)))
}